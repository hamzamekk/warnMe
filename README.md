...
The project was created using [react-native-warnme-template](https://github.com/warnme/react-native-template-warnme)
...
More details [how to customize App Icon and Splash screen](https://handbook.warnme.com/docs/mobile/generate-app-icon)

## Releasing and building the app with Github action

👉 https://handbook.warnme.com/docs/mobile/ci-cd/github-action-build

## 📚 Read More About Modules

👉 https://handbook.warnme.com/docs/mobile/get-started
# warnMe
